...
init_defalt_ui_boxes::proc(){
	...
	tg.create_ui_box(tg.UI_Box_Data{name="inspector_ui_box",update_proc=tg.inspector_ui_box,is_visible = true,inspector={parent = g.debug_info,do_depth = false}},g.ui_clay_inst)
