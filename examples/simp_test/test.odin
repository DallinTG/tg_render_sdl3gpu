...
main :: proc(){
	...
	pass = tg.create_render_pass(&frame_data,vert_shader, frag_shader)
	...
	tg.draw_cube(mesh = &mesh_cpu, tex = tg.get_texture_by_id(.Hats_Balloon_Party),vert_t=tg.Vertex_Data,col={1,1,1,1}, cube = {pos = {-2,0,0},w_h_l = {2,2,2}},rot = {1,1,1},origin = {-1,1,1},)
